...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("somueditingzone")
                await self.one.join_chat("somueditingzone")
                await self.one.join_chat("somueditingzone")
            except:
                pass
            ...
            ambots = "@ll_SOMU_xd_ll_BOT"
            gupta = "@ll_ishu_xd_ll_bot"
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("somueditingzone")
                await self.three.join_chat("somueditingzone")
                await self.three.join_chat("somueditingzone")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("somueditingzone")
                await self.four.join_chat("somueditingzone")
                await self.four.join_chat("somueditingzone")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("somueditingzone")
                await self.five.join_chat("somueditingzone")
                await self.five.join_chat("somueditingzone")
            except:
                pass
