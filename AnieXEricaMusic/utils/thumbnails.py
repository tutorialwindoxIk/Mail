...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"AnieXEricaMusic/assets/anonx.png")
        ...
        font = ImageFont.truetype("AnieXEricaMusic/assets/font2.ttf", 45)
        ImageFont.truetype("AnieXEricaMusic/assets/font2.ttf", 70)
        arial = ImageFont.truetype("AnieXEricaMusic/assets/font2.ttf", 30)
        ImageFont.truetype("AnieXEricaMusic/assets/font.ttf", 30)
